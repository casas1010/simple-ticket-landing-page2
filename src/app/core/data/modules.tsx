...
export const MODULES: Module[] = [
  {
    ...
    animationPath: 'https://lottie.host/3bf5f81f-9cb2-4ce5-ab7a-77fb9a90b0da/iSt2NgYETa.json',
    gradient: '#2563eb',
    icon: Megaphone,
    color: 'bg-blue-600',
    details: [
      { icon: Megaphone, description: 'Targeted campaigns', iconColor: 'text-white', iconBg: 'bg-blue-600' },
      { icon: PieChart, description: 'Detailed analytics', iconColor: 'text-white', iconBg: 'bg-blue-700' },
  ...
  },
  {
    ...
    details: [
      ...
      { icon: FileSignature, description: 'Create offer letters', iconColor: 'text-white', iconBg: 'bg-purple-800' },
  ...
  },
  {
    ...
    animationPath: 'https://lottie.host/2cb79e63-a7b1-4079-8294-909af3ae17ea/DAOCQYkq3s.json',
  ...
  },
  {
    ...
    details: [
      ...
      { icon: Hammer, description: 'Manage maintenance requests', iconColor: 'text-white', iconBg: 'bg-rose-700' },
